...
const VISUALS = [
  ...
  },
  {
    ...
    style: "minimaliste",
    label: "Minimaliste",
    items: "a premium white t-shirt, straight-leg tailored trousers in black, beige or grey, one sculptural minimal overshirt with clean architectural lines, minimalist white sneakers, a sober minimal watch",
    extra: "Color palette: white, cream, beige, grey, black — monochrome or near-monochrome. Architectural, precise silhouette with sharp clean lines. Extreme restraint: no patterns, no layering complexity, no relaxed or casual styling — distinctly more austere and precise than Casual chic.",
  },
  {
    gender: "homme",
    style: "casual_chic",
    ...
    extra: "An evident mix of one relaxed piece and one more elevated piece — polished but approachable.",
  },
  {
    gender: "homme",
    style: "classique_chic",
    label: "Classique chic",
    items: "a sharply structured navy blazer with a defined shoulder, a crisp white shirt, precisely tailored dress trousers, polished loafers or derby shoes, a leather belt, a classic watch",
    extra: "Color palette: navy, white, beige, grey, brown. Sharp, structured tailoring: crisp fabrics, defined shoulder line, precise clean seams, polished and formal. Distinctly more tailored and buttoned-up than Preppy — no collegiate or varsity references.",
  },
  {
    gender: "homme",
    style: "boheme",
    label: "Bohème",
    items: "a heavily textured linen shirt, loose or soft chino trousers in a raw natural fabric, a hand-knit or woven textured overshirt, soft natural leather shoes, one discreet natural accessory such as a leather bracelet or woven strap",
    extra: "Color palette: ecru, camel, olive, brown, sand — warm earthy tones only. Strongly emphasize raw, visible natural textures: nubby linen weave, rough suede or leather grain, hand-knit texture — a tactile, handcrafted, earthy feel, distinctly more textured than the other styles. No festival styling, no caricatural hippie look.",
  },
  {
    gender: "homme",
    style: "streetwear",
    label: "Streetwear",
    items: "a deliberately oversized premium hoodie or sweatshirt, a t-shirt, cargo trousers or loose jeans, chunky contemporary sneakers as the visual anchor, a crossbody bag, an optional cap",
    extra: "Strongly oversized, urban streetwear silhouette — deliberately boxy and voluminous, not fitted. Chunky sneakers as the dominant visual element. Utility-inspired details (pockets, drawstrings). Bold, confident urban attitude. A fashion streetwear aesthetic, emphatically NOT athletic or gym clothing — no performance fabric sheen, no sport branding cues, no tracksuit.",
  },
  {
    gender: "homme",
    style: "preppy",
    label: "Preppy",
    items: "a light blue Oxford shirt, a plain-color polo shirt or a twisted-stitch knit sweater, tailored chino trousers, polished loafers, a classic leather watch and belt",
    extra: "Color palette: navy, cream, camel, burgundy, sky blue. Adult, sophisticated, everyday-wearable preppy for 2026 — polished and refined, built around exactly one clear preppy signature (the Oxford collar), everything else kept clean and solid-colored. Contemporary modern adult fashion — avoid any schoolwear or uniform styling, avoid a teenage aesthetic.",
  },
];
