 ...
 * un produit clair illisible. Basé sur le nom de couleur : VestiaireRow ne
 * porte pas le hex, doit rester identique au miroir app (src/lib/imagePrompt.ts).
 */
...
const SUBTYPE_EN: Record<string, string> = {
  ...
  espadrilles: "espadrille sandals",
  ...
  "sac crossbody": "crossbody bag",
  "sac week-end": "weekender bag",
  "sac porte-documents": "briefcase",
  pochette: "clutch bag",
  "sac à dos": "backpack",
...
const COLOR_EN: Record<string, string> = {
  ...
  // Correctif 26/08/2026 (audit des 71 libellés couleur réellement en base) :
  // 35 d'entre eux n'avaient aucune entrée ici et repartaient tels quels
  // dans le prompt anglais via le repli color.toLowerCase() — "écru" en
  // tête, avec 58 références. Les bicolores "X / Y" sont traduits en toutes
  // lettres plutôt que découpés : translate() fait une correspondance
  // exacte sur la chaîne entière, jamais mot à mot.
  "écru": "off-white",
  brun: "brown",
  ...
  "kaki clair": "light khaki",
  "camel clair": "light camel",
  "marron foncé": "dark brown",
  "vert forêt": "forest green",
  "vert olive": "olive green",
  "vieux rose": "dusty rose",
  "blanc nacré": "pearl white",
  "beige naturel": "natural beige",
  "beige sable": "sand beige",
  "écaille": "tortoiseshell",
  "argent vieilli": "antique silver",
  "doré vieilli": "antique gold",
  "beige / écru": "beige and off-white",
  "beige / naturel": "natural beige",
  "blanc / ecru": "white and off-white",
  "bordeaux / écru": "burgundy and off-white",
  "camel / écru": "camel and off-white",
  "chocolat / écru": "chocolate brown and off-white",
  "doré / pierre": "gold with stone detail",
  "écru / beige": "off-white and beige",
  "écru / marine": "off-white and navy blue",
  "écru / noir": "off-white and black",
  "kaki / beige": "khaki and beige",
  "naturel / cognac": "natural and cognac",
  "noir / écru": "black and off-white",
  "nude / beige": "nude beige",
  "terracotta / écru": "terracotta and off-white",
  "terre / bois": "earth brown",
  bleu: "blue",
  marine: "navy blue",
  prune: "plum purple",
  violet: "purple",
...
export function buildImagePrompt(row: VestiaireRow, trend?: TrendRule | null): BuiltPrompt {
  ...
  const commonTemplate = [
    ...
    ...(isPaleColor(row.couleur_dominante)
      ? [
